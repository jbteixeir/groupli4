...
{
    public partial class Associacao_Zona_Coluna : Form
    {
        ...
        public Associacao_Zona_Coluna(object _zonas, object _associacao)
        {
            InitializeComponent();
            ...
            done_action += new eventoEventHandler(
               Camada_de_Interface.Interface_Importer_Matching.reencMapeamento);
        ...
        {
            Associacao_Zona_Coluna azc = new Associacao_Zona_Coluna(zonas, associacao);
            azc.ShowDialog();
        }
