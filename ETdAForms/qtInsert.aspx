<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qtInsert.aspx.cs" Inherits="qtInsert" %>
        ...
        <%if (success == 1)
          {
              ...
              Response.Write("<center><h3>Questionário submetido com sucesso!</h3></center>");
          }
          else
          {
              Response.Write("<form action=\"" + form + ".aspx?form="+form+"&usr="+usr+"&anl="+anl+"&prj="+prj+"\">");
              
              Response.Write("<center><h3>Erro ao submeter questionário</h3></center>");
          }%>
